...
namespace PongGame
{
    ...
    class PongClient : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // Load the messages
             _establishingConnectionMsg = Content.Load<Texture2D>("./Content/establishing-connection-msg.png");
            _waitingForGameStartMsg = Content.Load<Texture2D>("./Content/waiting-for-game-start-msg.png");
            _gamveOverMsg = Content.Load<Texture2D>("./Content/game-over-msg.png");

            // Load sound effects
            _ballHitSFX = Content.Load<SoundEffect>("./Content/ball-hit.wav");
            _scoreSFX = Content.Load<SoundEffect>("./Content/score.wav");
        }
